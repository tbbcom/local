...
const ILMU_KLINIK_PERLIS = [
  {
    name: "DVS PERLIS",
    address: "KM.3, JALAN UTAN AJI, 01000 KANGAR PERLIS PERLIS",
    area: "JALAN UTAN AJI",
    state: "PERLIS",
    clinicPhone: "49792600.0",
    mobilePhone: "",
    email: ""
  },
];

(function initKlinikTool_PERLIS() {
  ...
  function render(list) {
    ...
    countLabel.textContent = list.length + " klinik haiwan & klinik veterinar dijumpai di PERLIS.";
  }
  ...
  function applyFilters() {
    ...
    const base = ILMU_KLINIK_PERLIS.slice();
      ...
      nearMeBtn.addEventListener('click', function(){
        if (navigator.geolocation) {
          navigator.geolocation.getCurrentPosition(function(pos){
            ...
            window.open("https://www.google.com/maps/search/" + encodeURIComponent("klinik haiwan PERLIS near me"), "_blank", "noopener");
          });
        } else {
          window.open("https://www.google.com/maps/search/" + encodeURIComponent("klinik haiwan PERLIS near me"), "_blank", "noopener");
        }
